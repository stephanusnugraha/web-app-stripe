...
func (app *application) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		resp.Error = true
		resp.Message = "not matching email found on our system"
...
func (app *application) RefundCharge(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.badRequest(w, r, errors.New("the charge was refunded, but the db could not be updated"))
		return
	}
...
func (app *application) CancelSubscription(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.badRequest(w, r, errors.New("the subscription was cancelled, but the db could not be updated"))
		return
	}
